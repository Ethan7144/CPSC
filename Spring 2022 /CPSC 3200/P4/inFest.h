...
//     The Operator + will take two inFest objects and will combine them into one
//     larger array, the reasoning for this is since, inFest is an class of an Array of gridFleas,
//     it made sense to me to make the operators have to deal with specifically the array itself.
//     The only exception is == and !=, as this will check if the entire array is the same, so it will
//     check the gridFlea itself. The + will onky deal with the array, and not any of the gridFleas in the
//    array itself.
